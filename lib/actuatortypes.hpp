...
const std::vector<ActuatorProperties> actuatortypes {
  ...
  {"Lights","Electric Power Level",spawn::units::UnitType::W, spawn::units::UnitType::W},
  {"ElectricEquipment","Electric Power Level",spawn::units::UnitType::W, spawn::units::UnitType::W},
  {"OtherEquipment","Power Level",spawn::units::UnitType::W, spawn::units::UnitType::W},
  {"Surface","Interior Surface Convection Heat Transfer Coefficient",spawn::units::UnitType::W_per_m2_K, spawn::units::UnitType::W_per_m2_K},
  {"Surface","Exterior Surface Convection Heat Transfer Coefficient",spawn::units::UnitType::W_per_m2_K, spawn::units::UnitType::W_per_m2_K},
  {"Surface","Construction State",spawn::units::UnitType::one, spawn::units::UnitType::one},
  {"Surface","Outdoor Air Drybulb Temperature",spawn::units::UnitType::K, spawn::units::UnitType::C},
  {"Surface","Outdoor Air Wetbulb Temperature",spawn::units::UnitType::K, spawn::units::UnitType::C},
