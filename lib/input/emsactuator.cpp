...
EMSActuator::EMSActuator(std::string t_spawnname, std::string t_idfname, std::string t_idftype, std::string t_idfcontroltype) noexcept :
...
std::vector<EMSActuator> EMSActuator::createEMSActuators(const nlohmann::json & spawnjson, [[maybe_unused]] const nlohmann::json & jsonidf) {
