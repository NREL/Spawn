...
OutputVariable::OutputVariable(std::string t_spawnname, std::string t_idfname, std::string t_idfkey) :
...
std::vector<OutputVariable> OutputVariable::createOutputVariables(const nlohmann::json & spawnjson, const nlohmann::json & jsonidf) {
